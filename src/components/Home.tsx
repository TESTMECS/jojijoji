...
const Home = () => {
  const [videoSrc, setVideoSrc] = useState<string>(videoBg);
    ...
    <div id="Home" className=" w-screen h-screen">
      ...
      <header className="absolute top-[100vh]">
        <h1 className="text-5xl">
          <strong>Joji</strong> SMITHEREENS OUT NOW{" "}
        </h1>
        <div className="flex space-x-10 text-5xl">
          <a href="https://jojimusic.com/" target="_blank" rel="noreferrer">
            <h1> Tour </h1>
          </a>
          <a
      ...
      <div className="flex">
        <button
          id="play"
          className="absolute top-[195vh] left-[100px] text-white"
        ...
        <input
          id="progressbar"
          className="absolute top-[195vh] left-[200px]"
          type="range"
          min="0"
          max="100"
          step="0.1"
        ...
        <button
          id="fullscreenBtn"
          className="absolute top-[195vh] right-10"
